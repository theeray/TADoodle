...
import { DEFAULT_ZONE, localDate, safeZone, formatTime, makePoll, makeResponse, responseValues, rankTimes, groupGrid, slotLabel, slotTime, meetingSlots, STEP } from './scheduling';
...
export default function App() {
  ...
  return <div className="tadoodle-app">
    ...
    {route.type === 'create' ? <CreatePoll onDemo={openDemo} onPreview={startPreview} notify={setToast}/> : <PollView key={`${route.type}-${route.id || ''}-${preview?.poll.title || ''}`} id={route.id} demo={route.type === 'demo' ? demo : null} notify={setToast}/>}
...
function PollView({ id, demo, notify }) {
